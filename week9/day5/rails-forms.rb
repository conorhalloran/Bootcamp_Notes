1.) Install Simple Form: https://github.com/plataformatec/simple_form
    gem 'simple_form'

2.) Integrate Simple Form with Bootstrap:
    rails generate simple_form:install --bootstrap

3.) go to your _form.html.erb file in views folder:
    3.1) change: # <%= form_for @product do |form| %>
    3.2) to: # <%= simple_form_for @product do |form| %>
4.) remove entire form: 
=begin
